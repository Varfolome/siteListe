...
export default function Block_Pole(props) {
    ...
    let blockPhotos = null;

    switch (props.nbr) {

      case "1":
        blockPhotos = <img src={props.imgone} className="one_img_pole" alt={props.title} title={props.title} />;
        break;
      case "2":
        blockPhotos = <div className="photos">
      ...
      default: blockPhotos = <img src={props.imgone} className="one_img_pole" alt={props.title} title={props.title} />;

    }


    let blockText = <div><h5 className="textname">{props.textname} </h5> <h5 className="text">{props.text}</h5></div>;

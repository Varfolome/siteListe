...
export default function FirstBlock(props) {
  ...
  let textpresentation = "Quelques présentations...";
  ...
  let textPres2 = "Ulysse, le président : rationnel, pragmatique, et efficace. Il opère avec un ratio énergie/sommeil imbattable.";
  ...
  if (props.lang === "english") {
    textpresentation = "A few presentations";
  ...
  return (
    <div>
      <h1 className="page_title" > {textpresentation} </h1>
      {firstBlock}
    </div>
  );
}

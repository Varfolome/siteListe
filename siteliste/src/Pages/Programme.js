...
export default class Programme extends React.Component {
  ...
  render() {
    ...
    let specificPurposesJSX = specificPurposes.map((specificPurposeProps) => <li className="specific-purposes-list-element" key={specificPurposeProps[1]}><Purpose purposeImg={specificPurposeProps[0]} purposeName={specificPurposeProps[1]} purposeDescription={specificPurposeProps[2]}/><br/><hr/><br/></li>);
    ...
    return(
      <div className="programme">
        ...
        <div className="specific-purposes">
          <ul className="specific-purposes-list">
            {specificPurposesJSX}
          </ul>
        </div>
      </div>

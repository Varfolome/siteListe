...
export default class Programme extends React.Component {
  ...
  render() {
    ...
    let textSoiree = "L'objectif est de rendre l'expérience des soirées à l'INT inoubliable en visant toujours plus haut, toujours plus gros. En plus des traditionnelles soirées organisées par le BDE chaque année, on organiserait une sortie sur Paris pour la Technoparade et une sorte de Dîner Presque Parfait de la soirée en partenariat avec les autres écoles de l'Institut Polytechnique de Paris où il serait promis au vainqueur gloire et prestige éternels.";
    ...
    if (this.props.lang === "english") {
      ...
      textSoiree = "The goal is to make the INT party experience unforgettable by aiming higher and bigger. In addition to the traditional parties organized by the BDE every year we would organize an outing to Paris for the Technoparade and a kind of 'Dîner Presque Parfait' in partnership with other schools of Institut Polytechnique de Paris where glory and eternal prestige would be promised to the winner .";
